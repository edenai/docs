...
description: "One API. 500+ AI models. Use any LLM or AI feature with fallback, routing, and cost tracking built in."
mode: "wide"
---

import { SiteSchema } from "/snippets/SiteSchema.mdx";
...
<CardGroup cols={3}>
  ...
  <Card title="Built-in Reliability" icon="shield-check">
    Fallback, provider routing, and cost tracking out of the box.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="LLMs" icon="brain" href="/v3/llms/chat-completions">
    OpenAI-compatible chat completions with provider routing and streaming.
  </Card>
...
<br />
<br /><br /><br />
<Note>If you were a user before 2026/01/05, you still have access to the previous version: [https://old-app.edenai.run/](https://old-app.edenai.run/). We'll continue supporting the old version until the end of 2026.</Note>
