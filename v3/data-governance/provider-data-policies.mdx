...
All three columns describe the **provider's** own policy, not Eden AI's. Eden AI stores no request or response content whichever provider you route to, as described above. A provider marked **No** under ZDR may still keep your data briefly for abuse monitoring even when it does not train on it.

<Note>
  This information was last updated on 11 September 2026.
</Note>
