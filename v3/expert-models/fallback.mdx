...
When using Universal AI / expert models, there is no built-in fallback mechanism in the model string (unlike the [LLM smart routing](/v3/llms/smart-routing)). Instead, you implement fallback logic in your application code.
