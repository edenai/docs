...
| bytedance | `video/generation_async/bytedance` | $2.5 per 1,000,000 tokens |
...
| bytedance (seedance-2-0-260128) | `video/generation_async/bytedance/seedance-2-0-260128` | $6.79 per 1,000,000 tokens |
...
| minimax (MiniMax-Hailuo-02) | `video/generation_async/minimax/MiniMax-Hailuo-02` | $0.084 per request |
...
| openai (sora-2-pro) | `video/generation_async/openai/sora-2-pro` | $0.7 per second |
...
| pruna | `video/generation_async/pruna` | $0.02 per second |
