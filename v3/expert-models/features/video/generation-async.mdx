...
| bytedance | `video/generation_async/bytedance` | $0.0121782 per second |
| bytedance (dreamina-seedance-2-0-260128) | `video/generation_async/bytedance/dreamina-seedance-2-0-260128` | $0.0710395 per second |
| bytedance (dreamina-seedance-2-0-fast-260128) | `video/generation_async/bytedance/dreamina-seedance-2-0-fast-260128` | $0.0568316 per second |
| bytedance (dreamina-seedance-2-0-mini-260615) | `video/generation_async/bytedance/dreamina-seedance-2-0-mini-260615` | $3.5 per 1,000,000 tokens |
| bytedance (dreamina-seedance-2-5-260628) | `video/generation_async/bytedance/dreamina-seedance-2-5-260628` | $10.7 per 1,000,000 tokens |
| bytedance (seedance-1-0-pro-250528) | `video/generation_async/bytedance/seedance-1-0-pro-250528` | $0.0253713 per second |
| bytedance (seedance-1-0-pro-fast-251015) | `video/generation_async/bytedance/seedance-1-0-pro-fast-251015` | $0.0101485 per second |
...
| google (veo-3.1-fast-generate-preview) | `video/generation_async/google/veo-3.1-fast-generate-preview` | $0.12 per second |
| google (veo-3.1-generate-preview) | `video/generation_async/google/veo-3.1-generate-preview` | $0.4 per second |
...
| pruna | `video/generation_async/pruna` | $0.04 per second |
| pruna (p-video) | `video/generation_async/pruna/p-video` | $0.02 per second |
| pruna (p-video-2) | `video/generation_async/pruna/p-video-2` | $0.025 per second |
