...
description: "The provider_params field lets you pass provider-specific parameters that aren't part of Eden AI's unified schema."
---
...
<TechArticleSchema
  title={"Provider Parameters"}
  description={"The provider_params field lets you pass provider-specific parameters that aren't part of Eden AI's unified schema."}
  path="v3/expert-models/provider-parameters"
...
payload = {
    "model": "image/generation/openai/gpt-image-2",
    "input": {
...
{/* skip-test: downloads the generated image from its result URL and opens it in a desktop viewer, neither of which a test run can do */}
<CodeGroup>
```python Python
import requests
import base64
