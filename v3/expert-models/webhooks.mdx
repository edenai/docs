...
| `output`            | `object \| null`        | Normalized result. `null` on `status: "fail"`.                                         |
| `error`             | `object \| null`        | `{ "message": "..." }`. `null` on `status: "success"`.                                 |
...
<Tabs>
  <Tab title="Python">
    ...
    **Receiving and verifying the webhook (Flask):**
    ...
    {/* skip-test: a Flask receiver, not a script: it registers route handlers and loads Eden AI's webhook public key from a PEM file */}
    ```python
    import hashlib
    import orjson
  ...
  <Tab title="JavaScript">
    ...
    **Receiving and verifying the webhook (Express):**
    ...
    {/* skip-test: an Express receiver, not a script: it registers a route handler and loads Eden AI's webhook public key from a PEM file */}
    ```javascript
