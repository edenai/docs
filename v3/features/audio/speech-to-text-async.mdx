...
description: "Speech Recognition (or speech to text or voice to text) can recognize and transcribe spoken words (voice),  that will be converted to text with or without diarization. It is also possible to filter pr"
icon: "microchip-ai"
---

# Speech To Text

Speech Recognition (or speech to text or voice to text) can recognize and transcribe spoken words (voice),  that will be converted to text with or without diarization. It is also possible to filter profanity. The type of files allowed are: mp3, wav, m4a. If convert_to_wav option is set to true, then you can transcribe any type of audio or video files.
