...
description: "Image Generation is an advanced feature that generates compelling images based on a given text prompt. It can easily produce high-quality and original images in a matter of seconds, without the need f"
icon: "microchip-ai"
---

# Image generation

Image Generation is an advanced feature that generates compelling images based on a given text prompt. It can easily produce high-quality and original images in a matter of seconds, without the need for specialized design skills or software
...
| replicate | `image/generation/replicate` | $0.000225 per exec_time |
