...
Optical Character Recognition or Reader (OCR) is the electronic or mechanical conversion of images of typed, handwritten or printed text into machine-encoded text. The image can be a scanned document or a photo of a license plate, a road sign or anything else that contains text (type of files allowed: jpg, jpeg, png, tiff) .
