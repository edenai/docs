...
description: "Named Entity Recognition (also called entity identification or extraction) is an information extraction technique that automatically identifies named entities in a text and classifies them into predef"
icon: "microchip-ai"
---

# Named Entity Recognition

Named Entity Recognition (also called entity identification or extraction) is an information extraction technique that automatically identifies named entities in a text and classifies them into predefined categories such as dates, persons names, company names, dates, products etc.
