...
<Note>
Postpaid billing is arranged with the Eden AI team as part of an Advanced AI Platform / Enterprise plan. [Contact us](https://www.edenai.co/pricing) to enable it for your organization.
</Note>

## Checking Your Balance

You can check your current credit balance in the [Eden AI dashboard](https://app.edenai.run/). The balance itself is not exposed by the API, but you can track consumption programmatically with the [usage endpoints](/v3/general/monitoring) and cap spending with [key budgets](/v3/general/custom-api-keys#create-a-key-with-budget).
