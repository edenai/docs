...
description: "Eden AI provides team and organisation management features for companies that need structured access control, project separation, and governance over their AI usage."
---
...
<TechArticleSchema
  title={"Users & Organisation"}
  description={"Eden AI provides team and organisation management features for companies that need structured access control, project separation, and governance over their AI usage."}
  path="v3/general/users-organisation"
