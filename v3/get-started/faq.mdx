...
See [Getting Started](introduction.mdx) for detailed endpoint comparison.
...
See [Universal AI Getting Started](../how-to/universal-ai/getting-started.mdx) and [Chat Completions](../how-to/llm/chat-completions.mdx) for details.
...
See [Authentication Guide](../how-to/authentication/bearer-token-auth.mdx) for details.
...
See [Monitor Usage and Costs](../how-to/cost-management/monitor-usage.mdx) for tracking and optimization.
...
See [Upload Files](../how-to/upload/upload-files.mdx) for detailed guide.
...
Format support varies by provider. Check provider-specific documentation or use the [API Discovery](../how-to/discovery/explore-api.mdx) endpoint for details.
...
Even when `stream: false` is sent, responses are streamed. See [Streaming Responses](../how-to/llm/streaming.mdx) for implementation guide.
...
See [Working with Media Files](../how-to/llm/working-with-media.mdx) for complete guide.
...
See [Vision Capabilities](../how-to/llm/vision-capabilities.mdx) for provider comparison.
...
See [Explore the API](../how-to/discovery/explore-api.mdx) for details.
...
5. **Monitor usage:**
   - Track costs via [Monitor Usage](../how-to/cost-management/monitor-usage.mdx)
...
**For Universal AI:** Must be `feature/subfeature/provider[/model]`
...
- [Getting Started Guide](introduction.mdx)
- [Authentication Setup](../how-to/authentication/bearer-token-auth.mdx)
- [Universal AI Overview](../how-to/universal-ai/getting-started.mdx)
- [LLM Chat Completions](../how-to/llm/chat-completions.mdx)
- [Monitor Costs](../how-to/cost-management/monitor-usage.mdx)
