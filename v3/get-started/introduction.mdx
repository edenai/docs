...
### Universal AI
- [Getting Started with Universal AI](../how-to/universal-ai/getting-started.mdx) - Learn the universal endpoint
- [Text Features](../how-to/universal-ai/text-features.mdx) - AI detection, moderation, embeddings
- [OCR Features](../how-to/universal-ai/ocr-features.mdx) - Text extraction, document parsing
- [Image Features](../how-to/universal-ai/image-features.mdx) - Generation, detection, analysis

### OpenAI-Compatible LLM
- [Chat Completions](../how-to/llm/chat-completions.mdx) - Build conversational AI with streaming
- [Streaming Responses](../how-to/llm/streaming.mdx) - Handle Server-Sent Events
- [File Attachments](../how-to/llm/file-attachments.mdx) - Send images and documents to LLMs

### File Management
- [Upload Files](../how-to/upload/upload-files.mdx) - Persistent file storage

### API Discovery
- [Explore the API](../how-to/discovery/explore-api.mdx) - Programmatic feature discovery
