...
- **[Smart Routing How-To Guide](../how-to/llm/smart-routing.mdx)** - Advanced patterns and best practices
- **[Optimize LLM Costs Tutorial](../tutorials/optimize-llm-costs.mdx)** - Complete cost optimization workflow
- **[Streaming Guide](../how-to/llm/streaming.mdx)** - Handle SSE responses effectively
- **[Function Calling](../how-to/llm/chat-completions.mdx#function-calling)** - Use tools with smart routing
