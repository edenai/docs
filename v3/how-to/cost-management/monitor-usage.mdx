...
> **Note**: These are admin/dashboard endpoints typically used by the Eden AI dashboard or custom admin interfaces. For standard API usage authentication, see the [Authentication Guide](../authentication/bearer-token-auth.mdx).
...
- [Track and Optimize API Spending Tutorial](../../tutorials/track-optimize-spending.mdx)
- [Manage Custom Tokens](../../how-to/user-management/manage-tokens.mdx)
- [Authentication Guide](../../how-to/authentication/bearer-token-auth.mdx)
