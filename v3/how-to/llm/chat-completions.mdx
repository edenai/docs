...
- [Streaming Responses](streaming.mdx) - Handle Server-Sent Events
- [File Attachments](file-attachments.mdx) - Send images and documents
- [Working with Media Files](working-with-media.mdx) - Send images and files to LLMs
