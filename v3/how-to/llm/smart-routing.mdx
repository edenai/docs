...
This guide provides LLM-specific patterns and examples for smart routing. For comprehensive router documentation, see the [Smart Routing section](../router/getting-started.mdx).
...
- **[Router Getting Started](../router/getting-started.mdx)** - Core routing concepts and basics
- **[Router Advanced Usage](../router/advanced-usage.mdx)** - Advanced patterns and optimization
- **[Router Monitoring](../router/monitoring.mdx)** - Production monitoring and analytics
...
- **[Router Getting Started](../router/getting-started.mdx)** - Learn core routing concepts
- **[Router Advanced Usage](../router/advanced-usage.mdx)** - Master advanced routing patterns
- **[Router Monitoring](../router/monitoring.mdx)** - Track routing in production
- **[Optimize LLM Costs Tutorial](../../tutorials/optimize-llm-costs.mdx)** - Complete cost optimization workflow
- **[Chat Completions Guide](./chat-completions.mdx)** - Master the LLM endpoint
- **[Streaming Guide](./streaming.mdx)** - Handle SSE responses
