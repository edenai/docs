...
- **[Getting Started](./getting-started.mdx)** - Review routing basics
- **[LLM Smart Routing](../llm/smart-routing.mdx)** - Practical LLM-specific patterns
- **[Cost Optimization Tutorial](../../tutorials/optimize-llm-costs.mdx)** - Complete cost optimization workflow