...
- **[Getting Started](./getting-started.mdx)** - Learn router basics
- **[Advanced Usage](./advanced-usage.mdx)** - Master advanced patterns
- **[Cost Optimization Tutorial](../../tutorials/optimize-llm-costs.mdx)** - Complete cost optimization guide
- **[LLM Smart Routing](../llm/smart-routing.mdx)** - Practical LLM examples