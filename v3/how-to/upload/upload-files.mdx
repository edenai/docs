...
- [OCR Features](../universal-ai/ocr-features.mdx) - Use uploaded files for OCR
- [Image Features](../universal-ai/image-features.mdx) - Image processing
- [Universal AI Getting Started](../universal-ai/getting-started.mdx) - Using files in Universal AI
