...
> **Note**: These are admin/dashboard endpoints typically used by the Eden AI dashboard or custom admin interfaces. For standard API authentication, see the [Authentication Guide](../authentication/bearer-token-auth.mdx).
...
<CodeBlocks>
  <CodeBlock title="Python">
    ...
    result = response.json()
    print(f"Sandbox token created: {result['token']}")
    ```
  </CodeBlock>
</CodeBlocks>
...
<CodeBlocks>
  <CodeBlock title="Python">
    ...
    API_KEY = "eyJhbG...xxxxxxxxxxxxxxxxxxxxxxxx"
    TOKEN_NAME = "limited-budget-token"
...
- [Multi-Environment Token Management Tutorial](../../tutorials/multi-environment-tokens.mdx) - Complete workflow
- [Monitor Usage and Costs](../../how-to/cost-management/monitor-usage.mdx) - Track spending per token
- [Authentication Guide](../../how-to/authentication/bearer-token-auth.mdx) - Use your tokens
