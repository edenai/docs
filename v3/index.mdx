...
1. **[Getting Started Guide](get-started/introduction.mdx)** - Learn V3 basics
2. **[Universal AI Guide](how-to/universal-ai/getting-started.mdx)** - Use the universal endpoint
3. **[OpenAI-Compatible LLM](how-to/llm/chat-completions.mdx)** - Chat completions
4. **[File Upload Guide](how-to/upload/upload-files.mdx)** - Persistent file storage
5. **[API Discovery](how-to/discovery/explore-api.mdx)** - Explore programmatically

## Need Help?

- **Getting Started**: [Introduction Guide](get-started/introduction.mdx)
- **API Reference**: Check the V3 API tab for detailed specs
- **Support**: Visit [Eden AI Support](https://edenai.co/)

---

**Ready to get started with V3?** Jump to the [Getting Started Guide](get-started/introduction.mdx) or explore the [Universal AI Guide](how-to/universal-ai/getting-started.mdx).