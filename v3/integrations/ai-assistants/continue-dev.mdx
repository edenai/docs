...
<CodeBlocks>
  <CodeBlock title="~/.continue/config.json">
    ```json
    {
      "models": [
        {
...
- **Complex reasoning**: Use `anthropic/claude-3-5-sonnet-20241022`
...
- [VS Code Integration](../ides/vscode) - More VS Code AI tools
- [Claude Code](./claude-code) - Official Claude CLI
- [Cline](./cline) - Another powerful VS Code extension
- [API Reference](/v3-api/reference) - Eden AI API documentation
