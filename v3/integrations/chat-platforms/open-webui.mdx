...
<CodeBlocks>
  <CodeBlock title=".env">
    ...
    MODEL_FILTER_LIST=anthropic/claude-3-5-sonnet-20241022,openai/gpt-4
    ```
  </CodeBlock>
</CodeBlocks>
...
<CodeBlocks>
  <CodeBlock title="docker-compose.prod.yml">
    ```yaml
    version: '3.8'
