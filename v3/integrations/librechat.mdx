---
title: "LibreChat"
icon: "/integration-logo/librechat-icondoc.svg"
description: "Configure LibreChat, the open-source ChatGPT alternative, to use Eden AI for access to 500+ AI models."
---
...
<TechArticleSchema
  title={"LibreChat"}
  description={"Configure LibreChat, the open-source ChatGPT alternative, to use Eden AI for access to 500+ AI models."}
  path="v3/integrations/librechat"
  articleSection="Chat UI"
  about={"LLM Chat Interface"}
  proficiencyLevel="Intermediate"
  keywords={["Eden AI", "AI API", "LibreChat"]}
  datePublished="2026-05-06T00:00:00Z"
  dateModified="2026-08-31T00:00:00Z"
/>

Configure LibreChat, the open-source ChatGPT alternative, to use Eden AI for access to 500+ AI models.
...
- **500+ models**: Access OpenAI, Anthropic, Google, Cohere, and more through one interface
...
OPENAI_REVERSE_PROXY=https://api.edenai.run/v3

# Optional: Enable multiple endpoints
ANTHROPIC_API_KEY=YOUR_EDEN_AI_API_KEY
ANTHROPIC_REVERSE_PROXY=https://api.edenai.run/v3

GOOGLE_API_KEY=YOUR_EDEN_AI_API_KEY
GOOGLE_REVERSE_PROXY=https://api.edenai.run/v3
  ...
  custom:
    - name: "Eden AI"
      ...
      models:
        ...
        fetch: false
      titleConvo: true
      titleModel: "openai/gpt-mini-latest"
      summarize: false
      summaryModel: "openai/gpt-mini-latest"
      forcePrompt: false
...
endpoints:
  custom:
    - name: "Eden AI"
      ...
      summaryModel: "anthropic/claude-haiku-latest"
```
</CodeGroup>
...
- [OpenAI SDK (Python)](./openai-sdk-python) - Programmatic access
- [Monitoring](/v3/general/monitoring) - Track usage and spending
