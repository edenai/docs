---
title: "Open WebUI"
icon: "/integration-logo/openwebui-icondoc.svg"
description: "Configure Open WebUI (formerly Ollama WebUI) to use Eden AI for accessing 500+ AI models through a sleek interface."
---
...
<TechArticleSchema
  title={"Open WebUI"}
  description={"Configure Open WebUI (formerly Ollama WebUI) to use Eden AI for accessing 500+ AI models through a sleek interface."}
  path="v3/integrations/open-webui"
  articleSection="Chat UI"
  about={"LLM Chat Interface"}
  proficiencyLevel="Intermediate"
  keywords={["Eden AI", "AI API", "Open WebUI"]}
  datePublished="2026-05-06T00:00:00Z"
  dateModified="2026-08-31T00:00:00Z"
/>

Configure Open WebUI (formerly Ollama WebUI) to use Eden AI for accessing 500+ AI models through a sleek interface.
...
docker run -d \
  ...
  -e OPENAI_API_BASE_URL=https://api.edenai.run/v3 \
...
Generate images through Eden AI's image models:
...
services:
  open-webui:
    ...
    environment:
      ...
      - OPENAI_API_BASE_URLS=https://api.edenai.run/v3,https://api.openai.com/v1
...
MODEL_FILTER_LIST=anthropic/claude-sonnet-latest,openai/gpt-latest
```
</CodeGroup>
