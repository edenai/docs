...
description: "Use the official OpenAI Python SDK with Eden AI to access 500+ AI models through a familiar interface."
---
...
<TechArticleSchema
  title={"OpenAI Python SDK"}
  description={"Use the official OpenAI Python SDK with Eden AI to access 500+ AI models through a familiar interface."}
  path="v3/integrations/openai-sdk-python"
  articleSection="AI Frameworks"
  about={"LLM Framework Integration"}
  proficiencyLevel="Intermediate"
  keywords={["Eden AI", "AI API", "OpenAI SDK", "Python"]}
...
**Meta Llama** (served by EU hosts, the id carries the host)
- `scaleway/llama-3.3-70b-instruct`
- `ionos/meta-llama/Meta-Llama-3.1-8B-Instruct`
