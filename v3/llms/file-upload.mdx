---
icon: "file-arrow-up"
description: "Learn how to upload and manage files with V3's persistent file storage system."
---
...
{/* skip-test: reads the file from an <input> element in a browser page, which node has no equivalent of */}
