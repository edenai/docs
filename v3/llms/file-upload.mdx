...
When uploading a file, the optional `purpose` field describes your intended use. This helps Eden AI route and optimize the file for the right feature:
...
Specifying the correct `purpose` ensures your file is handled appropriately and enables intent-based filtering in the dashboard.
...
<CardGroup cols={2}>
  <Card title="OCR" icon="file-lines" href="/v3/expert-models/features/ocr/ocr">
    Use uploaded documents for text extraction
  </Card>
