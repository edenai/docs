...
|---|---|
| Google | `google/gemini-3.1-flash-image`, `google/gemini-3-pro-image`, `google/imagen-4.0-generate-001` |
...
|---|---|---|
| `model` | yes | `provider/model`, e.g. `google/gemini-3.1-flash-image` |
