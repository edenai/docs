...
description: "Generate and edit images through the chat completions endpoint using LLMs that natively support image output."
---
...
|---|---|---|
| **Gemini 2.5 Flash Image / 3 Pro Image** | `google/gemini-2.5-flash-image`, `google/gemini-3-pro-image-preview` | Google |
