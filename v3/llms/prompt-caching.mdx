...
1. Body `session_id`
2. Session request headers (`x-session-id`, `x-claude-code-session-id`, `x-session-affinity` or `session-id`)
3. `prompt_cache_key`
