...
description: "Ask typed questions about text and get calibrated probabilities back instead of prose. One request, no streaming, billed on input only."
icon: "scale-balanced"
tag: "Alpha"
---
...
<TechArticleSchema
  title={"System One (Decisions)"}
  description={"Ask typed questions about text and get calibrated probabilities back instead of prose. One request, no streaming, billed on input only."}
  path="v3/llms/system-one"
  articleSection="LLMs"
  about={"LLM API"}
  proficiencyLevel="Intermediate"
  keywords={["Eden AI", "AI API", "LLM API", "decision model", "classification", "TypeSafe", "Jev"]}
  datePublished="2026-09-22T00:00:00Z"
  dateModified="2026-09-22T00:00:00Z"
/>

A System One model answers **typed questions about text**. You send some state and the questions you want answered, and you get back a choice, a score, or a probability, each with a confidence, in a single pass.
