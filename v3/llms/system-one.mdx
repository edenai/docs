...
- [Chat completions](/v3/llms/chat-completions) — when you need words back.
- [Listing models](/v3/llms/listing-models) — discovery across every V3 catalog.
- [Structured output](/v3/llms/structured-output) — when you want a schema-shaped answer out of a generative model instead.
