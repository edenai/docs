...
<Card title="Make Your First LLM Call" icon="rocket" href="/v3/quickstart/first-llm-call">
  Send a chat completion request in under a minute.
</Card>

<Card title="Make Your First Expert Model Call" icon="wand-magic-sparkles" href="/v3/quickstart/first-expert-model-call">
