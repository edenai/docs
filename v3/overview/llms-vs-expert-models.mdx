...
description: "Eden AI V3 provides two main endpoints. Both share the same base URL (https://api."
---
...
<TechArticleSchema
  title={"LLMs vs Expert Models"}
  description={"Eden AI V3 provides two main endpoints. Both share the same base URL (https://api."}
  path="v3/overview/llms-vs-expert-models"
...
Examples: `openai/gpt-latest`, `anthropic/claude-sonnet-latest`, `vertex/gemini-flash-latest`
...
Examples: `text/moderation/openai`, `ocr/financial_parser/google`, `image/generation/openai/gpt-image-2`
