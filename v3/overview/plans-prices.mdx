...
| Rate limit | 7 req/sec (15 on request) | Custom (higher) |
| Bulk discounts | -- | Yes |
...
- **Higher rate limits & bulk discounts** -- beyond 15 req/sec, tailored to your workload, plus volume-based pricing
