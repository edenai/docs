...
icon: "gauge-high"
title: "Rate Limits"
description: "Eden AI applies a per-account rate limit on requests to the API. The limit can be raised based on the volume and pattern of traffic you need to support."
---
