...
For advanced token management including multi-environment setups, budget controls, and token rotation, see the [full sandbox and token management guide](/v3/general/sandbox).
