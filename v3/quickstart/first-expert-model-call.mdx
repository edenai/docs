---
sidebarTitle: "First Expert Model Call"
title: "First Expert Model call"
icon: "wand-magic-sparkles"
description: "Get started with Eden AI's Universal AI endpoint for expert models (OCR, image analysis, text processing, and more)."
---
...
<TechArticleSchema
  title={"First Expert Model call"}
  description={"Get started with Eden AI's Universal AI endpoint for expert models (OCR, image analysis, text processing, and more)."}
  path="v3/quickstart/first-expert-model-call"
  articleSection="Quickstart"
  about={"LLM API Integration"}
  proficiencyLevel="Beginner"
  keywords={["Eden AI", "AI API", "quickstart", "first API call"]}
...
- `image/generation/openai/gpt-image-2` - Image generation
...
| **Image** | Generation, detection, analysis | `image/generation/openai/gpt-image-2` |
| **Audio** | Speech-to-text, text-to-speech | `audio/tts/elevenlabs` |
| **Translation** | Document translation | `translation/document_translation/google` |
