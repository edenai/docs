...
description: "Make your first call to Eden AI's OpenAI-compatible LLM endpoint and start building with 500+ models."
icon: "rocket"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Provider Routing" icon="shuffle" href="/v3/llms/provider-routing">
    Name a model without a provider and let Eden AI pick one
  </Card>
</CardGroup>
