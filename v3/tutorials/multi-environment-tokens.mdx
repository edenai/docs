...
<CodeBlocks>
  <CodeBlock title="token_manager.py">
    ```python
    import requests
...
<CodeBlocks>
  <CodeBlock title="token_rotation.py">
    ```python
...
<CodeBlocks>
  <CodeBlock title="token_lifecycle.py">
    ```python
    from token_manager import TokenManager
...
<CodeBlocks>
  <CodeBlock title="token_monitor.py">
    ```python
    import requests
    from token_manager import TokenManager
    from typing import Dict, List
...
<CodeBlocks>
  <CodeBlock title="token_alerts.py">
    ```python
    from token_manager import TokenManager
...
<CodeBlocks>
  <CodeBlock title="setup_environments.py">
    ```python
    #!/usr/bin/env python3
    import os
    from token_manager import TokenManager
...
- [Manage Custom Tokens Guide](../how-to/user-management/manage-tokens.mdx) - API reference
- [Monitor Usage and Costs](../how-to/cost-management/monitor-usage.mdx) - Track per-token spending
- [Track and Optimize Spending](track-optimize-spending.mdx) - Cost optimization
